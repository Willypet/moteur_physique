...
namespace Physics {
	...
	Matrix3 Matrix3::operator*(const Matrix3& other) const
	{
		return Matrix3(
			...
			value[0][0] * other.value[0][1] + value[0][1] * other.value[1][1] + value[0][2] * other.value[1][2],
			...
			value[1][0] * other.value[0][1] + value[1][1] * other.value[1][1] + value[1][2] * other.value[1][2],
			...
			value[2][0] * other.value[0][1] + value[2][1] * other.value[1][1] + value[2][2] * other.value[1][2],
